            ...
            <form class="form-horizontal" method="post" action="@isset($data) /push_all/{{ $data['key'] }} @else /push_all @endif" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Judul Notification" name="judul" value="@isset($data) {{ $data['judul'] }} @endif" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="konten" class="col-sm-2 control-label">Konten</label>
                  <div class="col-sm-10">
                    <textarea class="form-control" rows="3" placeholder="Konten Notification ..." name="konten" required>@isset($data) {{ $data['konten'] }} @endif</textarea>
                  </div>
                </div>
              <!-- /.box-body -->
